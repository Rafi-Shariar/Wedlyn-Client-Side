...
export const Statistic = () => {
    ...
    useEffect(()=>{
         ...
         axios.get(`${import.meta.env.VITE_URL}/stats`)
        .then((res)=>{
            setCounts(res.data);
  ...
  <div className="grid gap-10 row-gap-8 lg:grid-cols-3">
    ...
    <div className="text-center">
      ...
      <p className="mb-2 text-xl font-semibold text-gray-900">Registered Brides</p>
    ...
    <div className="text-center">
      ...
      <p className="mb-2 text-xl font-semibold text-gray-900">Registered Grooms</p>
      <p className="text-gray-600 max-w-sm mx-auto">
        Connect with thousands of verified groom profiles actively searching
        for their perfect life partner. Join our community to find your match.
      </p>
    </div>
    ...
    <div className="text-center">
      ...
      <p className="mb-2 text-xl font-semibold text-gray-900">Successful Marriages</p>
      <p className="text-gray-600 max-w-sm mx-auto">
        Celebrating the journeys of couples united through Wedlyn, we proudly
        share success stories of marriages that started right here on our platform.
      </p>
    </div>
  </div>
</div>
